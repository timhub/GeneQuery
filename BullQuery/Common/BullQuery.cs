...
public class BullQuery
{
    public BullQuery()
    {
        ...
        conn.Open();
        connstr = "uid=root; pwd=111111;Database=bulldb ; Data source=(local)";
    }
    ...
    public SqlConnection conn = new SqlConnection("uid=root; pwd=111111;Database=bulldb ; Data source=(local)");
